...
export default defineConfig({
  ...
  webServer: {
    ...
    command: 'npm run build && npm run preview -- --port 4230 --strictPort',
    url: 'http://localhost:4230/crypto-lab-lwe-hints/',
  ...
  projects: [
    {
      name: 'chromium',
      use: {
        baseURL: 'http://localhost:4230/crypto-lab-lwe-hints/',
        colorScheme: 'dark',
      },
    },
  ],
